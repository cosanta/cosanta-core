...
BOOST_AUTO_TEST_CASE(truncated_pos_header_deserialization_fails)
{
    ...
    SerializeData data(ss.begin(), ss.end());
...
BOOST_AUTO_TEST_CASE(ser_gethash_pow_payload)
{
    ...
    SerializeData netBytes(ssNet.begin(), ssNet.end());
    SerializeData hashBytes(ssHash.begin(), ssHash.end());
...
BOOST_AUTO_TEST_CASE(ser_gethash_pos_differs_from_pow_same_base)
{
    ...
    SerializeData powBytes(ssPow.begin(), ssPow.end());
    SerializeData posBytes(ssPos.begin(), ssPos.end());
