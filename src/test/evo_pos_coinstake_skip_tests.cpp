...
// =========================================================================
BOOST_FIXTURE_TEST_SUITE(evo_pos_coinstake_skip_tests, TestChainV19Setup)
...
BOOST_AUTO_TEST_CASE(build_new_list_from_block_skips_coinstake)
{
    ...
    BlockValidationState statePoW;
    {
        ...
        BOOST_CHECK(m_node.dmnman->BuildNewListFromBlock(
            ...
            m_node.chainman->ActiveChainstate().CoinsTip(), mnListPoW, false));
    }
    ...
    BlockValidationState statePoS;
    {
        ...
        bool result = m_node.dmnman->BuildNewListFromBlock(
            ...
            m_node.chainman->ActiveChainstate().CoinsTip(), mnListPoS, false);
...
BOOST_AUTO_TEST_CASE(build_new_list_collateral_check_skips_coinstake)
{
    ...
    BlockValidationState state;
    {
        ...
        bool result = m_node.dmnman->BuildNewListFromBlock(
            ...
            m_node.chainman->ActiveChainstate().CoinsTip(), mnList, false);
