        ...
        RPCResult{
            RPCResult::Type::ARR, "", "",
            {
                {RPCResult::Type::OBJ, "", "",
                {
                    ...
                    {RPCResult::Type::NUM, "satoshis", "The difference of units"},
        ...
        RPCResult{
            RPCResult::Type::ARR, "", "",
            {
                {RPCResult::Type::OBJ, "", "",
                {
                    ...
                    {RPCResult::Type::NUM, "satoshis", "The number of units of the output"},
...
static RPCHelpMan getaddressbalance()
{
    return RPCHelpMan{"getaddressbalance",
        ...
        RPCResult{
            RPCResult::Type::OBJ, "", "",
                {
                    {RPCResult::Type::NUM, "balance", "The current total balance in units"},
                    {RPCResult::Type::NUM, "balance_immature", "The current immature balance in units"},
                    {RPCResult::Type::NUM, "balance_spendable", "The current spendable balance in units"},
                    {RPCResult::Type::NUM, "received", "The total number of units received (including change)"},
                }},
        RPCExamples{
...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    /* Cosanta features */
    { "cosanta",            "mnsync",                 &mnsync,                 {"mode"} },
    { "cosanta",            "spork",                  &spork,                  {"command"} },
    { "cosanta",            "sporkupdate",            &sporkupdate,            {"name","value"} },
