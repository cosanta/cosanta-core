...
// Sets hashProofOfStake on success return
bool CheckProofOfStake(BlockValidationState& state, const CBlockHeader& block, uint256& hashProofOfStake, const Consensus::Params& consensus, const BlockManager* blockman = nullptr, const CChain* active_chain = nullptr, const CTxMemPool* mempool = nullptr);
