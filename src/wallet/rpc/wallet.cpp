    ...
    return RPCHelpMan{"getwalletinfo",
                ...
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
                        ...
                        {RPCResult::Type::NUM, "keypoolsize_hd_internal", "how many new keys are pre-generated for internal use (used for change outputs and mobile coinjoin)"},
                        ...
                        {RPCResult::Type::STR_HEX, "hdchainid", /*optional=*/true, "the ID of the HD chain. Only present if the wallet is HD"},
                        {RPCResult::Type::NUM, "hdaccountcount", /*optional=*/true, "how many accounts of the HD chain are in this wallet. Only present if the wallet is HD"},
                        {RPCResult::Type::ARR, "hdaccounts", /*optional=*/true, "Only present if the wallet is HD",
                            {
                            {RPCResult::Type::OBJ, "", "",
                                {
                                    {RPCResult::Type::NUM, "hdaccountindex", "the index of the account"},
                                    {RPCResult::Type::NUM, "hdexternalkeyindex", /*optional=*/true, "current external childkey index"},
                                    {RPCResult::Type::NUM, "hdinternalkeyindex", /*optional=*/true, "current internal childkey index"},
                                    {RPCResult::Type::STR, "error", /*optional=*/true, "description of why the account could not be read"},
                            }},
                        }},
