    ...
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            RPCHelpMan{"dumpprivkey",
                ...
                .ToString() +
            "\nArguments:\n"
            "1. \"address\"   (string, required) The cosanta addressg for the private key\n"
            "\nResult:\n"
    ...
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            RPCHelpMan{"dumpwallet",
                ...
                .ToString() +
            "\nArguments:\n"
            "1. \"filename\"    (string, required) The filename with path (either absolute or relative to cosantad)\n"
            "\nResult:\n"
            "{                           (json object)\n"
