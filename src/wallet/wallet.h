...
public:
    ...
    static bool Verify(interfaces::Chain& chain, const WalletLocation& location, std::string& error_string, std::vector<std::string>& warnings);
    ...
    bool AutoBackupWallet(const fs::path& wallet_path, std::string& error_string, std::vector<std::string>& warnings);
