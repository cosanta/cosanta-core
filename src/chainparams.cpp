...
public:
    CMainParams() {
        ...
        // Cosanta Platform address HRP (bech32m)
        bech32_platform_hrp = "cosa";

        // Cosanta BIP44 coin type is '770'
        nExtCoinType = 770;
        ...
        strSporkAddress = "CPU5ip4oDKkmcSfbZkmeXnMq5aTQUSRtwz";
...
public:
    CTestNetParams() {
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_V24].bit = 12;
        consensus.vDeployments[Consensus::DEPLOYMENT_V24].nStartTime = 1790208000;     // September 24, 2026 00:00:00 UTC
        ...
        strSporkAddress = "certvWMfGR8ahresKNppg8LZf84kmXUiZy";
        fBIP9CheckMasternodesUpgraded = true;
...
public:
    explicit CDevNetParams(const ArgsManager& args) {
        ...
        strSporkAddress = "oRg7XeNysTv1djHe21x4DNe2kuGCpkwxvC";
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        strSporkAddress = "santaeu6dAf3tren1oTEhgRfuTc8f88nZk";
        fBIP9CheckMasternodesUpgraded = false;
