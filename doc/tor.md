...
- Starting with version 20.0, Cosanta Core only supports Tor version 3 hidden
  services (Tor v3). Tor v2 addresses are ignored by Cosanta Core and neither
  relayed nor stored.
...
versions of Tor see [Section 4](#4-automatically-listen-on-tor).*
    ...
    HiddenServicePort 60606 127.0.0.1:9604
    HiddenServicePort 60696 127.0.0.1:9694

The directory can be different of course, but virtual port numbers should be equal to
your cosantad's P2P listen port (60606 by default), and target addresses and ports
should be equal to binding address and port for inbound Tor connections (127.0.0.1:9604 by default for mainnet, 127.0.0.1:9694 for testnet).
