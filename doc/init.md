...
`/etc/dash/cosanta.conf` with the current systemd, OpenRC, and Upstart init
files out-of-the-box. This is because the command line options specified in the
init files take precedence over the configurations in
`/etc/dash/cosanta.conf`. However, some init systems have their own
...
setting the COSAD and FLAGS environment variables in the file
