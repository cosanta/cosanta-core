...
Note
---------------------
Always use absolute paths to configure and compile Cosanta Core and the dependencies.
...
This will build cosanta-qt as well, if the dependencies are met.
...
memory available when compiling Cosanta Core. On systems with less, gcc can be
...
If you want to build cosanta-qt, make sure that the required packages for Qt development
...
Once these are installed, they will be found by configure and a cosanta-qt executable will be
built by default.
...
Notes
-----
The release is built with GCC and then "strip cosantad" to strip the debug
...
Otherwise, you can build Cosanta Core from self-compiled [depends](/depends/README.md).

**Note**: You only need Berkeley DB if the wallet is enabled (see [*Disable-wallet mode*](#disable-wallet-mode)).

Security
--------
To help make your Cosanta Core installation more secure by making certain attacks impossible to
...
As mentioned above, when maintaining portability of the wallet between the standard Cosanta Core distributions and independently built
