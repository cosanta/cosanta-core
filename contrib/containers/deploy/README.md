...
official/supported Docker Images found at https://hub.docker.com/r/cosanta/cosanta-cored/
...
**NOTE: Please update the image description at https://hub.docker.com/r/cosanta/cosanta-cored-develop/ when changing the above text**
