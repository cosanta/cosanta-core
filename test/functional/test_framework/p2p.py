...
# Version 70242 introduced the MSG_ASSET_UNLOCK inventory type; 70241 introduced CoinJoin
# rebalance (promotion/demotion) sessions and a version-gated flags field in the dsa message
P2P_VERSION = 70242
...
class P2PConnection(asyncio.Protocol):
    ...
    def peer_accept_connection(self, connect_id, connect_cb=lambda: None, *, net, timeout_factor, supports_v2_p2p, reconnect, uacomment=None):
        ...
        logger.debug('Listening for Cosanta Node with id: {}'.format(connect_id))
