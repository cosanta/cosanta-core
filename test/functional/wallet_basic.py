...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 210 COSA from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 1000 COSA in block rewards plus fees, but
        ...
        # Send 100 COSA with subtract fee from amount
        ...
        # Sendmany 100 COSA with subtract fee from amount
        ...
        # Sendmany 5 COSA to two addresses with subtracting fee from both addresses
        ...
        # Fee subtraction is rounded to whole units, so the split across equal
        # recipients can differ by one unit.
        ...
        self.log.info("Test sendmany with fee_rate param (explicit fee rate in unit/B)")
        fee_rate_sat_vb = 2
        ...
        assert_raises_rpc_error(-6, "Fee rate (0.999 unit/B) is lower than the minimum fee rate setting (1.000 unit/B)",
        ...
        msg = "Fee rate (0.000 unit/B) is lower than the minimum fee rate setting (1.000 unit/B)"
        ...
        # Test fee_rate values that cannot be represented in unit/B.
        ...
        for target, mode in product([-1, 0], ["cosa/kb", "unit/b"]):
        ...
        if not self.options.descriptors:
            ...
            # This will raise an exception for attempting to get the private key of an invalid Cosanta address
            assert_raises_rpc_error(-5, "Invalid Cosanta address", self.nodes[0].dumpprivkey, "invalid")

            # This will raise an exception for attempting to set a label for an invalid Cosanta address
            assert_raises_rpc_error(-5, "Invalid Cosanta address", self.nodes[0].setlabel, "invalid address", "label")

            # This will raise an exception for importing an invalid address
            assert_raises_rpc_error(-5, "Invalid Cosanta address or script", self.nodes[0].importaddress, "invalid")
            ...
            self.log.info("Test sendtoaddress with fee_rate param (explicit fee rate in unit/B)")
        ...
        if self.options.descriptors:
            ...
            multi_a = descsum_create("sh(multi(1,tpubD6NzVbkrYhZ4YBNjUo96Jxd1u4XKWgnoc7LsA1jz3Yc2NiDbhtfBhaBtemB73n9V5vtJHwU6FVXwggTbeoJWQ1rzdz8ysDuQkpnaHyvnvzR/*,tpubD6NzVbkrYhZ4YHdDGMAYGaWxMSC1B6tPRTHuU5t3BcfcS3nrF523iFm5waFd1pP3ZvJt4Jr8XmCmsTBNx5suhcSgtzpGjGMASR3tau1hJz4/*))")
            multi_b = descsum_create("sh(multi(1,tpubD6NzVbkrYhZ4YHdDGMAYGaWxMSC1B6tPRTHuU5t3BcfcS3nrF523iFm5waFd1pP3ZvJt4Jr8XmCmsTBNx5suhcSgtzpGjGMASR3tau1hJz4/*,tpubD6NzVbkrYhZ4Y2RLiuEzNQkntjmsLpPYDm3LTRBYynUQtDtpzeUKAcb9sYthSFL3YR74cdFgF5mW8yKxv2W2CWuZDFR2dUpE5PF9kbrVXNZ/*))")
